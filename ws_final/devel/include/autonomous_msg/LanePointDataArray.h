...
struct LanePointDataArray_
{
  ...
  _id_type id;
   ...
   typedef std::vector< ::autonomous_msg::LanePointData_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::autonomous_msg::LanePointData_<ContainerAllocator> >::other >  _lane_type;
  _lane_type lane;
